...
This is the Ollama embeddings variant of 3_11_langgraph_STM_RAG_chatbot.py:
embeddings are computed locally via a running Ollama server instead of
downloading a HuggingFace sentence-transformers model.
'''
...
# vectors are a different size than all-mpnet-base-v2's, so they can't share
# a collection.
PERSIST_DIR = "c://code//agenticai//3_langgraph//banking_chromadb_ollama"
COLLECTION_NAME = "chroma_bank_faq_ollama"
